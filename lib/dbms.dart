...
class DBMS {
  ///This is the MethodChannel used to communicate with the Java Code.
  ...
  ///Constructor for DBMS(DataBaseManagementSystem).
  DBMS._privateConstructor();
  static final DBMS dbms = DBMS._privateConstructor();

  ///_db is the database for the program to hold all data.
  static Database _db;


  ///createUser() creates a new user with the given email, password, and date
  ///to start checking messages
  ...
  ///updateLastCheck() updates the time of the users last email check to the
  ///current time.
  ...
  ///createFilter() creates a filter for checking the email inbox
  ///returns the filter as a list of maps
  ...
  ///queryUserData() returns user data as a list.
  ...
  ///queryAllBuckets() returns a list of all buckets.
  ...
  ///queryAllKeywords() returns a list of all keyword mappings.
  ...
  ///keywordsByBucket() returns a list of keywords for a given email.
  ...
  ///getFilterAddresses() returns a list of all addresses in the filter.
  ...
  ///queryAllAddresses() returns a list of all address mappings
  ...
  ///addKeyword() adds a given keyword to a given email address in the filter.
